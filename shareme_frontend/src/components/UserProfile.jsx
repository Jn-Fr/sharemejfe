...
const randomImage = 'https://source.unsplash.com/1600x900/?technology,photography,wallpaper';
...
const UserProfile = () => {
  ...
  const [text, setText] = useState('Pins creados'); // Created or saved
